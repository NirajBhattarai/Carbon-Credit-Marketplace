...
export type VerificationStandard = 'VCS' | 'Gold Standard' | 'Climate Action Reserve' | 'American Carbon Registry'
export type ProjectType = 'Forest Conservation' | 'Renewable Energy' | 'Ocean Restoration' | 'Carbon Capture' | 'Wildlife Conservation'

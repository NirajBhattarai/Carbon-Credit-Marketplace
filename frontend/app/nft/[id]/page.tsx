          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              <div className="flex items-center space-x-3 mb-4">
                ...
                />
                <div>
                  <h3 className="font-semibold text-gray-900">{nft.collection.name}</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                />
                <div>
                  <div className="font-semibold text-gray-900">{nft.owner.name}</div>
                  <div className="text-sm text-gray-600">{nft.owner.address}</div>
                </div>
              </div>
            </div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="font-mono text-sm text-gray-900">{nft.contractAddress}</div>
                      </div>
                      <div>
                        <div className="text-sm text-gray-500">Token ID</div>
                        <div className="font-mono text-sm text-gray-900">{nft.tokenId}</div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between py-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="font-semibold text-gray-900">Minted</div>
                          <div className="text-sm text-gray-600">

      ...
      >
        <div className='flex items-center justify-between mb-3'>
          <div className='flex items-center space-x-2'>
            <div
              className={`p-1 rounded ${deviceType === 'SEQUESTER' ? 'bg-green-100' : 'bg-orange-100'}`}
            >
            ...
            <div>
              ...
              {data.apiKey && (
                <div className='flex items-center space-x-1 text-xs text-blue-500'>
                  ...
                  <span className='font-mono text-xs'>
                    {data.apiKey.slice(0, 6)}...
                  </span>
                </div>
              )}
            </div>
          </div>
          <Badge className={getDeviceTypeColor(deviceType)}>{deviceType}</Badge>
        </div>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='text-right'>
            <div className='text-sm text-gray-600'>
              Devices: {deviceCount.sequesters} Sequesters,{' '}
              {deviceCount.emitters} Emitters
            </div>
            <div className='text-sm text-gray-600'>
                  ...
                  <div className='flex flex-col'>
                    ...
                    {message.payload.walletAddress && (
                      <span className='text-xs text-gray-500 font-mono'>
                        💳 {message.payload.walletAddress.slice(0, 4)}...
                        {message.payload.walletAddress.slice(-3)}
                      </span>
                    )}

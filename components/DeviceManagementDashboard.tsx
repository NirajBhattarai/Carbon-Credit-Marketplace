...
export function DeviceManagementDashboard({
  ...
  const [sortBy, setSortBy] = useState<'createdAt' | 'lastSeen' | 'deviceId'>(
    'createdAt'
  );
            ...
            <div className='text-2xl font-bold text-green-600'>
              {
                devices.filter(d => {
                  ...
                  const diffMinutes =
                    (new Date().getTime() - new Date(d.lastSeen).getTime()) /
                    (1000 * 60);
        ...
        <div className='flex flex-wrap gap-4 items-center'>
          <div>
            ...
            <select
              value={filter}
              onChange={e =>
                setFilter(e.target.value as 'ALL' | 'SEQUESTER' | 'EMITTER')
              }
          ...
          <div>
            ...
            <select
              ...
              onChange={e =>
                setSortBy(
                  e.target.value as 'createdAt' | 'lastSeen' | 'deviceId'
                )
              }
              className='px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500'
            >

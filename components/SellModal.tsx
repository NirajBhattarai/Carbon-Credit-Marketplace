...
export default function SellModal({
  ...
  const [step, setStep] = useState<
    'price' | 'confirm' | 'processing' | 'success'
  >('price');
                  ...
                  <div className='grid grid-cols-2 gap-2'>
                    {[
                      ...
                      <button
                        key={option.value}
                        onClick={() =>
                          setDuration(option.value as '1' | '3' | '7' | '30')
                        }
              ...
              <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6'>
                <div className='flex items-start'>
                  ...
                  <div className='text-sm text-yellow-800'>
                    ...
                    <p>
                      Once listed, this item will be available for purchase by
                      other users. You can cancel the listing anytime before
                      it's sold.
                    </p>
                  </div>
                </div>
        ...
        {step === 'success' && (
          <div className='p-6 text-center'>
            ...
            <p className='text-gray-600 mb-6'>
              {nft.name} is now available for purchase
            </p>
            <button
              onClick={handleClose}
              className='w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg font-semibold transition-colors'

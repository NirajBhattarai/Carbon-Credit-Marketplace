...
export default function FilterBar({ onFilterChange, totalItems }: FilterBarProps): JSX.Element {
  ...
  const elements = ['all', 'Mangrove Restoration', 'Coral Reef Protection', 'Blue Carbon Sequestration', 'Marine Protected Areas', 'Ocean Cleanup', 'Seaweed Farming', 'Coastal Wetlands', 'Deep Sea Conservation']
    ...
    <div className="bg-gradient-to-r from-white to-gray-50 border-b border-gray-200 px-6 py-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          {/* Rarity Filter */}
          <div className="flex items-center space-x-3">
            <label className="text-sm font-semibold text-gray-700 whitespace-nowrap">Rarity:</label>
            <div className="relative">
              <select
                value={filters.rarity}
                onChange={(e) => handleFilterChange({ rarity: e.target.value as FilterOptions['rarity'] })}
                className="appearance-none bg-white border border-gray-300 rounded-xl px-4 py-2.5 text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-8 shadow-sm hover:shadow-md transition-shadow"
              >
          ...
          {/* Element Filter */}
          <div className="flex items-center space-x-3">
            <label className="text-sm font-semibold text-gray-700 whitespace-nowrap">Project Type:</label>
            <div className="relative">
              <select
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) => handleFilterChange({ burnStatus: e.target.value as FilterOptions['burnStatus'] })}
                  className="appearance-none bg-white border border-gray-300 rounded-xl px-4 py-2.5 text-sm font-medium focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-8 shadow-sm hover:shadow-md transition-shadow"
                >
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-2 bg-white border border-gray-300 rounded-xl px-4 py-2.5 shadow-sm hover:shadow-md transition-shadow">
                ...
                <input
                  ...
                  onChange={(e) => handleFilterChange({
                    priceRange: { ...filters.priceRange, max: parseFloat(e.target.value) || 100 }
                  })}
                  className="w-16 border-0 text-sm font-medium focus:ring-0 focus:outline-none"
                />
            ...
            {/* Credit Range */}
            <div className="flex items-center space-x-3">
              <label className="text-sm font-semibold text-gray-700 whitespace-nowrap">Credits:</label>
              <div className="flex items-center space-x-2 bg-white border border-gray-300 rounded-xl px-4 py-2.5 shadow-sm hover:shadow-md transition-shadow">
                <input
                  type="number"
                  placeholder="Min"
                  ...
                  onChange={(e) => handleFilterChange({
                    creditRange: { ...filters.creditRange, min: parseFloat(e.target.value) || 0 }
                  })}
                  className="w-16 border-0 text-sm font-medium focus:ring-0 focus:outline-none"
                />
                <span className="text-gray-400">-</span>
                <input
                  ...
                  onChange={(e) => handleFilterChange({
                    creditRange: { ...filters.creditRange, max: parseFloat(e.target.value) || 1000 }
                  })}
                  className="w-16 border-0 text-sm font-medium focus:ring-0 focus:outline-none"
                />

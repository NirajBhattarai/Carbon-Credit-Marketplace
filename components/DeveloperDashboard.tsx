...
} from '@/components/auth/AuthenticationHandler';
...
export function DeveloperDashboard() {
  ...
  const fetchApiKeys = async (applicationId: string) => {
    try {
      ...
      const response = await fetch(
        `/api/developer/applications/${applicationId}/api-keys`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
  ...
  const createApiKey = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/developer/applications/${selectedApp.id}/api-keys`,
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const revokeApiKey = async (keyId: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/developer/applications/${selectedApp.id}/api-keys/${keyId}`,
        {
          method: 'DELETE',
          headers: {
            Authorization: `Bearer ${token}`,
    ...
    return (
      <div className='max-w-4xl mx-auto p-6'>
        <Card className='p-8 text-center'>
          <h2 className='text-2xl font-bold mb-4'>Developer Dashboard</h2>
          <p className='text-gray-600 mb-6'>
            Wallet connected! Please authenticate to access the dashboard.
          </p>
          <div className='flex flex-col items-center gap-4'>
            <CustomConnectButton />
            <AuthenticationStatus />
        ...
        <div className='flex justify-between items-start mb-4'>
          <div>
            ...
            <p className='text-gray-600'>
              Manage your applications and API keys for IoT device integration
            </p>
          </div>
            ...
            <div className='flex items-center justify-between'>
              <div>
                <h3 className='font-semibold text-lg'>
                  Welcome, {user.username || user.name || 'Developer'}!
                </h3>
        ...
        {applications.length === 0 && !loading && (
          <Card className='p-12 text-center border-2 border-dashed border-gray-300 bg-gray-50/50'>
            <div className='max-w-md mx-auto'>
              ...
              <p className='text-gray-600 mb-6'>
                Create your first application to start building with our API and
                manage your IoT devices.
              </p>
              <Button
                onClick={() => setShowCreateApp(true)}
                className='bg-blue-600 hover:bg-blue-700 rounded-md font-semibold px-6 py-3 shadow-md hover:shadow-lg transition-shadow duration-150 border-0'
              >
                <svg
        ...
        <div className='mb-8'>
          <div className='flex items-center justify-between mb-6'>
            <div>
              ...
              <p className='text-gray-600 mt-1'>
                Manage your API key for {selectedApp.name}
              </p>
            </div>
            {selectedApp.apiKey && (
              <Button
          ...
          {selectedApp.apiKey ? (
            ...
            <Card className='p-12 text-center border-2 border-dashed border-gray-300 bg-gray-50/50'>
              <div className='max-w-md mx-auto'>
                <div className='w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4'>
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin='round'
                      strokeWidth='2'
                      d='M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H3a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z'
                    />
                  </svg>
                </div>
                <h3 className='text-lg font-semibold text-gray-900 mb-2'>
                ...
                <p className='text-gray-600 mb-6'>
                  This application doesn't have an API key yet. Create one to
                  start integrating with our services.
                </p>
                <Button
      ...
      >
        <div className='max-w-2xl mx-auto'>
          ...
          <div className='text-center mb-8'>
            ...
            <p className='text-gray-600'>
              Set up your application to start integrating with our IoT platform
          ...
          <div className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-xs text-gray-500'>
                This will be displayed on your application cards and used for
                identification.
              </p>
            </div>
            ...
            <div className='space-y-2'>
              ...
              />
              <p className='text-xs text-gray-500'>
                Optional: Help others understand your application's purpose.
              </p>
            </div>
            ...
            <div className='space-y-2'>
              ...
              <div className='relative'>
                <Input
                  ...
                  onChange={e =>
                    setAppForm({ ...appForm, website: e.target.value })
                  }
              ...
              <p className='text-xs text-gray-500'>
                Optional: Link to your application's website or documentation.
              </p>
            </div>
              ...
              <div className='flex items-start gap-3'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-green-700'>
                    Your application will automatically receive an API key with
                    read and write permissions for IoT devices.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className='max-w-lg mx-auto'>
          ...
          <div className='text-center mb-6'>
            ...
            <p className='text-gray-600 text-sm'>
              Add an API key to your application for device integration.
            </p>
          </div>
          ...
          <div className='space-y-4'>
            <div className='bg-yellow-50 border border-yellow-200 rounded p-4'>
              <p className='text-sm text-yellow-800 mb-2'>
                ...
                full API key. Make sure to copy it and store it securely.
              </p>
            </div>
            <div>

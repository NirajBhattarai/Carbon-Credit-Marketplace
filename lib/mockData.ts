...
export const mockNFTs: CarbonCreditNFT[] = [
  {
    ...
    description:
      'A rare cosmic explorer NFT from the Space Collection. This digital artwork represents the beauty of space exploration.',
    image:
  ...
  },
  {
    ...
    description:
      'An abstract digital art piece representing dreams and imagination in the digital realm.',
    image:
  ...
  },
  {
    ...
    description:
      'A legendary cyberpunk warrior from the future. This NFT represents strength and technology.',
    image:
  ...
  },
  {
    ...
    description:
      'A mystical nature spirit representing the harmony between technology and nature.',
    image:
  ...
  },
  {
    ...
    description:
      'A vintage-style robot from the golden age of science fiction.',
    image:
  ...
  },
  {
    ...
    description:
      'The first and most powerful dragon in the Mystic Realm collection.',
    image:
...
export const mockCollections: Collection[] = [
  {
    ...
    description:
      'Verified carbon credits from reforestation and forest conservation projects worldwide',
    image:
      'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=300&h=300&fit=crop',
    banner:
      'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200&h=300&fit=crop',
  ...
  },
  {
    ...
    description:
      'Carbon credits from solar, wind, and hydroelectric renewable energy projects',
    image:
      'https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=300&h=300&fit=crop',
    banner:
      'https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=1200&h=300&fit=crop',
  ...
  },
  {
    ...
    description:
      'Carbon credits from marine conservation, blue carbon, and ocean restoration projects',
    image:
...
const generateOceanConservationNFTs = (): CarbonCreditNFT[] => {
  ...
  const getPriceByRarity = (rarity: string): number => {
    switch (rarity) {
      case 'legendary':
        return Math.random() * 5 + 8; // 8-13 ETH
      case 'epic':
        return Math.random() * 2 + 3; // 3-5 ETH
      case 'rare':
        return Math.random() * 1 + 1; // 1-2 ETH
      default:
        return Math.random() * 0.5 + 0.2; // 0.2-0.7 ETH
    }
  };
  ...
  for (let i = 1; i <= 10000; i++) {
    ...
    const ownerAvatar =
      ownerAvatars[Math.floor(Math.random() * ownerAvatars.length)];
    const image = oceanImages[Math.floor(Math.random() * oceanImages.length)];
    const verificationStandard =
      verificationStandards[
        Math.floor(Math.random() * verificationStandards.length)
      ];

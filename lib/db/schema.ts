...
export const userCarbonCredits = pgTable('user_carbon_credits', {
  ...
  credits: decimal('credits', { precision: 18, scale: 8 })
    .notNull()
    .default('0'),
  co2Reduced: decimal('co2_reduced', { precision: 10, scale: 2 })
    .notNull()
    .default('0'),
  energySaved: decimal('energy_saved', { precision: 10, scale: 2 })
    .notNull()
    .default('0'),
  temperatureImpact: decimal('temperature_impact', { precision: 5, scale: 2 })
    .notNull()
    .default('0'),
  humidityImpact: decimal('humidity_impact', { precision: 5, scale: 2 })
    .notNull()
    .default('0'),
...
export const userCreditHistory = pgTable('user_credit_history', {
  ...
  temperatureImpact: decimal('temperature_impact', {
    precision: 5,
    scale: 2,
  }).notNull(),
  humidityImpact: decimal('humidity_impact', {
    precision: 5,
    scale: 2,
  }).notNull(),
...
export const carbonCreditTransactionsRelations = relations(
...
export const userCarbonCreditsRelations = relations(
  userCarbonCredits,
  ({ one }) => ({
    user: one(users, {
...
export const userCreditHistoryRelations = relations(
  userCreditHistory,
  ({ one }) => ({
    user: one(users, {
...
export type CarbonCreditTransaction =
  typeof carbonCreditTransactions.$inferSelect;
export type NewCarbonCreditTransaction =
  typeof carbonCreditTransactions.$inferInsert;

    ...
    <main className='min-h-screen bg-gray-50'>
      ...
      <section className='bg-gradient-to-br from-emerald-600 via-green-600 to-teal-600 text-white py-20 relative overflow-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10'>
          ...
          <p className='text-xl mb-8 max-w-3xl mx-auto text-emerald-100 leading-relaxed'>
            Trade verified carbon credits from industry leaders like South Pole,
            Finite Carbon, and Blue Source. Join Shell, Microsoft, and Delta in
            offsetting emissions through blockchain-powered transparency.
          </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Discover and trade verified carbon credits from leading
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            <div className='bg-gradient-to-br from-green-50 to-blue-50 rounded-xl p-6 border border-green-200'>
              ...
              <p className='text-gray-600 mb-4'>
                Protecting endangered forests and wildlife habitats
              </p>
            ...
            <div className='bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-200'>
              ...
              <p className='text-gray-600 mb-4'>
                Solar and wind energy projects reducing fossil fuel dependence
              </p>
              <div className='flex justify-between items-center'>
                <div>
            ...
            <div className='bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200'>
              ...
              <p className='text-gray-600 mb-4'>
                Marine ecosystem restoration and coral reef protection
              </p>
              <div className='flex justify-between items-center'>
                <div>
      ...
      <section className='py-16 bg-gray-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Leading carbon credit projects with verified impact and
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <div className='bg-white rounded-xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600 mb-6'>
                Protecting 500,000 hectares of Amazon rainforest from
                deforestation, preserving biodiversity and indigenous
                communities.
              </p>
              <div className='flex justify-between items-center'>
            ...
            <div className='bg-white rounded-xl p-8 shadow-lg'>
              ...
              <p className='text-gray-600 mb-6'>
                Large-scale solar energy project providing clean electricity to
                rural communities and reducing coal dependency across India.
              </p>
              <div className='flex justify-between items-center'>
                <div className='flex items-center'>
                  <div className='w-3 h-3 bg-green-500 rounded-full mr-2'></div>
      ...
      <section className='py-16 bg-gradient-to-r from-blue-50 to-purple-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <h2 className='text-3xl font-bold text-gray-900 mb-4'>
            Trade Carbon Credits Instantly
          </h2>
          <p className='text-lg text-gray-600 max-w-3xl mx-auto mb-8'>
            Use our decentralized exchange to buy and sell carbon credits with
            stablecoins. No intermediaries, transparent pricing, and instant
            settlement.
          </p>
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
      ...
      <section className='py-16 bg-gradient-to-r from-red-50 to-orange-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Every carbon credit is tracked on-chain. When credits reach zero,
              they are automatically burned to prevent double-spending and
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='bg-white rounded-xl p-6 shadow-lg text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Credits available for use and trading
              </p>
            ...
            <div className='bg-white rounded-xl p-6 shadow-lg text-center'>
              ...
              <p className='text-gray-600 mb-4'>
                Credits with less than 20% remaining
              </p>
          ...
          <div className='mt-12 text-center'>
            <div className='bg-white rounded-xl p-6 shadow-lg max-w-2xl mx-auto'>
              ...
              <p className='text-gray-600 text-sm'>
                When a carbon credit reaches 0 remaining credits, it is
                automatically burned on-chain. This prevents double-spending and
                ensures each credit represents a unique environmental impact.
                Burned credits are permanently retired and cannot be traded or
                used again.
              </p>
            </div>
          </div>
      ...
      <section className='py-16 bg-gradient-to-r from-gray-50 to-green-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Join the world's largest carbon credit developers and major
              corporate buyers in the fastest-growing environmental market
            </p>
          </div>
      ...
      <section className='py-16 bg-gradient-to-r from-blue-50 to-green-50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
              Unlike traditional carbon markets, our blockchain platform ensures
              every credit is verified, traceable, and tamper-proof
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='text-center p-6 bg-white rounded-xl shadow-lg'>
              ...
              <p className='text-gray-600'>
                Gold Standard, Verra VCS, and Climate Action Reserve certified
                projects
              </p>
            </div>
            ...
            <div className='text-center p-6 bg-white rounded-xl shadow-lg'>
              ...
              <p className='text-gray-600'>
                Smart contracts enable immediate, secure transactions without
                intermediaries
              </p>
            </div>
            ...
            <div className='text-center p-6 bg-white rounded-xl shadow-lg'>
              ...
              <p className='text-gray-600'>
                Projected to reach $250B by 2050 - join the fastest-growing
            ...
            {[
              {
                ...
                icon: '🌲',
                count: '125K',
                desc: 'Reforestation & Conservation',
              },
              {
                name: 'Ocean Credits',
                icon: '🌊',
                count: '89K',
                desc: 'Blue Carbon & Marine',
              },
              {
                name: 'Renewable Energy',
                icon: '⚡',
                count: '45K',
                desc: 'Solar, Wind & Hydro',
              },
              {
                name: 'Carbon Capture',
                icon: '🌱',
                count: '67K',
                desc: 'Direct Air Capture',
              },
              {
                name: 'Wildlife Conservation',
                icon: '🦋',
                count: '34K',
                desc: 'Biodiversity Protection',
              },
              {
              ...
              <div
                key={category.name}
                className='text-center p-6 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors border border-gray-100 hover:border-green-200'
              >

...
export const metadata: Metadata = {
  ...
  description:
    'Trade verified carbon credits with blockchain-powered transparency. Join the $250B carbon credit revolution.',
  keywords:
    'carbon credits, carbon trading, blockchain, sustainability, climate, eco, environment',

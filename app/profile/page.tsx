          ...
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <div className="flex items-center space-x-6 text-sm text-gray-500">
                <span>Joined {new Date(mockUser.joined).toLocaleDateString()}</span>
                <span>•</span>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-2xl font-bold text-gray-900">{mockUser.stats.itemsOwned}</div>
              <div className="text-sm text-gray-600">Items</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-gray-900">{mockUser.stats.collections}</div>
              <div className="text-sm text-gray-600">Collections</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-gray-900">{mockUser.stats.volumeTraded} ETH</div>
            ...
            {activeTab === 'activity' && (
              <div className="space-y-4">
                {ownedNFTs.map((nft, index) => (
                  <div key={nft.id} className="flex items-center justify-between py-4 border-b border-gray-200 last:border-b-0">
